//
//  PGLLibraryPropertiesView.swift
//  RiftEffects
//
...
class PGLLibraryPropertiesView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        titleLabel.font = PGLAppearance.titleFont
        titleLabel.textColor = UIColor.label
        titleLabel.adjustsFontForContentSizeCategory = true

        subtitleLabel.font = PGLAppearance.subtitleFont
